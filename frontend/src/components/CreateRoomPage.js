        ...
        return (<Grid container spacing={1}>
            ...
            <Grid item xs={12} align='center'>
                ...
                <FormControl component='fieldset'>
                    ...
                    <RadioGroup row defaultValue='true' onChange={handleGuestsCanPauseChange}>
            ...
            <Grid item xs={12} align='center'>
                <FormControl>
                    <TextField required={true} onChange={handleVotesChange} type='number' defaultValue={defaultVotes} inputProps={{min: 1, style:{textAlign: 'center'}}}/>
